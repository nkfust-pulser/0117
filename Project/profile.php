                ...
                <div class="col-md-10 form-group">
                  <div class="row">
                    ...
                    <div class="col-md-4 form-group <?php echo (!empty($user_weight_err)) ? 'has-error' : ''; ?>">
                      <label>身高(CM)</label>
                      <input type="text" id="height" maxlength= "6" class="form-control" name="user_height" value="<?php echo($_SESSION['user_height']);?>">
                    ...
                    <div class="col-md-4 form-group <?php echo (!empty($user_height_err)) ? 'has-error' : ''; ?>">
                      <label>體重(KG)</label>
                      <input type="text" id="weight" maxlength= "6" class="form-control" name="user_weight" value="<?php echo($_SESSION['user_weight']);?>">
...
<script>
  $(document).ready(function(){
    ...
    $('#phone').on('keyup', function(){
      $validation_phone = /^09\d{2}-?\d{3}-?\d{3}$/;
    ...
    $('#height').on('keyup', function(){
      $validation_height = /^[0-9]{1,3}(.[0-9]{0,2})?$/;
    ...
    $('#weight').on('keyup', function(){
      $validation_weight = /^[0-9]{1,3}(.[0-9]{0,2})?$/;
