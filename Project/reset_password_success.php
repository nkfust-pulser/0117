<?php 
session_start();
if(empty($_SESSION['reset_password_success'])){
  session_destroy();
  header('Location:forget_password.php');
  exit();
}
$_SESSION['after_reset'] = true;
?>
<html lang="en">
    ...
    <div class="container-fluid">
      <form id="myForm" method="post">
        ...
        <div class="form-group">
          <div class="text-left"><label class="title">更新密碼成功!</label></div>
          <div class="form_inside_padding"></div>
          <div class="form_inside_padding"></div>
          <?php echo '<label><i class="fa fa-user" aria-hidden="true"></i> 使用者 '.$_SESSION["param_userid"]?><?php echo '</label>'?>
          <div class="form_inside_padding"></div>
