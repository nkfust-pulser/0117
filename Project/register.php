  ...
  if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($user_real_name_err) && empty($mail_address_err)){
        ...
        <div class="container-fluid" id="formContent">
          <div class="register_box">
            ...
            <div class="form-group" <?php echo (!empty($username)) ? 'has-error' : ''; ?>">
              ...
              <input placeholder="請輸入帳號..." class="form-control" type="text" name="user_register_id" id="userid" spellcheck="false" autocomplete="off">
    ...
    <script>
      ...
      function valipassthru(){
        ...
        console.log('userid_vali' +  userid_vali);
        console.log('name_vali' +  name_vali);
        console.log('password_vali' +  password_vali);
        console.log('password_confirmation_vali' + password_confirmation_vali);
        console.log('mail_address_vali' +  mail_address_vali);
      }
